...
namespace ListHell.Controllers
{
    ...
    public class AccountController : Controller
    {
       // private ApplicationSignInManager _signInManager;
        ...
        {
            UserManager = new CustomUserManager(new CustomUserStore());
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //var identity = await UserManager.CreateIdentityAsync(, DefaultAuthenticationTypes.ApplicationCookie);
            ////identity.AddClaim(new Claim("UserName", )); //This is what I added
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(CODE.Users user)
        {
            if (ModelState.IsValid)
            {
